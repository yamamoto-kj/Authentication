...
namespace Authentication.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819200852_TwoFactorAuth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.Empresa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "EmpresaId", "Name");
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<int?>("RateLimitPermitsPerMinute")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.TenantRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.TenantRolePermission", b =>
                {
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.Vinculo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.VinculoEmpresa", b =>
                {
                    ...
                    b.HasKey("VinculoId", "EmpresaId");

                    b.HasIndex("EmpresaId");

                    b.ToTable("VinculoEmpresas");
                });

            modelBuilder.Entity("Authentication.Domain.Entities.WebAuthnCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.Empresa", b =>
                {
                    b.HasOne("Authentication.Domain.Entities.Tenant", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.Product", b =>
                {
                    b.HasOne("Authentication.Domain.Entities.Empresa", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.TenantRolePermission", b =>
                {
                    ...
                    b.HasOne("Authentication.Domain.Entities.TenantRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Authentication.Domain.Entities.VinculoEmpresa", b =>
                {
                    ...
                    b.HasOne("Authentication.Domain.Entities.Vinculo", null)
                        .WithMany()
